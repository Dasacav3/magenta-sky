...
function start(){if(!document.body)warn("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?");dispatch(document,"alpine:init");dispatch(document,"alpine:initializing");startObservingMutations();onElAdded(function(el){return initTree(el,walk);});onElRemoved(function(el){return nextTick(function(){return destroyTree(el);});});onAttributesAdded(function(el,attrs){directives(el,attrs).forEach(function(handle){return handle();});});var outNestedComponents=function outNestedComponents(el){return!closestRoot(el.parentNode||closestRoot(el));};Array.from(document.querySelectorAll(allSelectors())).filter(outNestedComponents).forEach(function(el){initTree(el);});dispatch(document,"alpine:initialized");}var rootSelectorCallbacks=[];var initSelectorCallbacks=[];function rootSelectors(){return rootSelectorCallbacks.map(function(fn){return fn();});}function allSelectors(){return rootSelectorCallbacks.concat(initSelectorCallbacks).map(function(fn){return fn();});}function addRootSelector(selectorCallback){rootSelectorCallbacks.push(selectorCallback);}function addInitSelector(selectorCallback){initSelectorCallbacks.push(selectorCallback);}function closestRoot(el){if(rootSelectors().some(function(selector){return el.matches(selector);}))return el;if(!el.parentElement)return;return closestRoot(el.parentElement);}function isRoot(el){return rootSelectors().some(function(selector){return el.matches(selector);});}function initTree(el){var walker=arguments.length>1&&arguments[1]!==undefined?arguments[1]:walk;deferHandlingDirectives(function(){walker(el,function(el2,skip){directives(el2,el2.attributes).forEach(function(handle){return handle();});el2._x_ignore&&skip();});});}function destroyTree(root){walk(root,function(el){return cleanupAttributes(el);});}// packages/alpinejs/src/plugin.js
...
addInitSelector(function(){return"[".concat(prefix("init"),"]");});directive("init",skipDuringClone(function(el,_ref39){var expression=_ref39.expression;return evaluate(el,expression,{},false);}));// packages/alpinejs/src/directives/x-text.js
directive("text",function(el,_ref40,_ref41){var expression=_ref40.expression;var effect3=_ref41.effect,evaluateLater2=_ref41.evaluateLater;var evaluate2=evaluateLater2(expression);effect3(function(){evaluate2(function(value){mutateDom(function(){el.textContent=value;});});});});// packages/alpinejs/src/directives/x-html.js
directive("html",function(el,_ref42,_ref43){var expression=_ref42.expression;var effect3=_ref43.effect,evaluateLater2=_ref43.evaluateLater;var evaluate2=evaluateLater2(expression);effect3(function(){evaluate2(function(value){el.innerHTML=value;});});});// packages/alpinejs/src/directives/x-bind.js
mapAttributes(startingWith(":",into(prefix("bind:"))));directive("bind",function(el,_ref44,_ref45){var value=_ref44.value,modifiers=_ref44.modifiers,expression=_ref44.expression,original=_ref44.original;var effect3=_ref45.effect;if(!value)return applyBindingsObject(el,expression,original,effect3);if(value==="key")return storeKeyForXFor(el,expression);var evaluate2=evaluateLater(el,expression);effect3(function(){return evaluate2(function(result){if(result===void 0&&expression.match(/\./))result="";mutateDom(function(){return bind(el,value,result,modifiers);});});});});function applyBindingsObject(el,expression,original,effect3){var getBindings=evaluateLater(el,expression);var cleanupRunners=[];effect3(function(){while(cleanupRunners.length){cleanupRunners.pop()();}getBindings(function(bindings){var attributes=Object.entries(bindings).map(function(_ref46){var _ref47=_slicedToArray(_ref46,2),name=_ref47[0],value=_ref47[1];return{name:name,value:value};});directives(el,attributes,original).map(function(handle){cleanupRunners.push(handle.runCleanups);handle();});});});}function storeKeyForXFor(el,expression){el._x_keyExpression=expression;}// packages/alpinejs/src/directives/x-data.js
addRootSelector(function(){return"[".concat(prefix("data"),"]");});directive("data",skipDuringClone(function(el,_ref48,_ref49){var expression=_ref48.expression;var cleanup=_ref49.cleanup;expression=expression===""?"{}":expression;var magicContext={};injectMagics(magicContext,el);var dataProviderContext={};injectDataProviders(dataProviderContext,magicContext);var data2=evaluate(el,expression,{scope:dataProviderContext});injectMagics(data2,el);var reactiveData=reactive(data2);initInterceptors(reactiveData);var undo=addScopeToNode(el,reactiveData);if(reactiveData["init"])reactiveData["init"]();cleanup(function(){undo();reactiveData["destroy"]&&reactiveData["destroy"]();});}));// packages/alpinejs/src/directives/x-show.js
directive("show",function(el,_ref50,_ref51){var modifiers=_ref50.modifiers,expression=_ref50.expression;var effect3=_ref51.effect;var evaluate2=evaluateLater(el,expression);var hide=function hide(){return mutateDom(function(){el.style.display="none";el._x_isShown=false;});};var show=function show(){return mutateDom(function(){if(el.style.length===1&&el.style.display==="none"){el.removeAttribute("style");}else{el.style.removeProperty("display");}el._x_isShown=true;});};var clickAwayCompatibleShow=function clickAwayCompatibleShow(){return setTimeout(show);};var toggle=once(function(value){return value?show():hide();},function(value){if(typeof el._x_toggleAndCascadeWithTransitions==="function"){el._x_toggleAndCascadeWithTransitions(el,value,show,hide);}else{value?clickAwayCompatibleShow():hide();}});var oldValue;var firstTime=true;effect3(function(){return evaluate2(function(value){if(!firstTime&&value===oldValue)return;if(modifiers.includes("immediate"))value?clickAwayCompatibleShow():hide();toggle(value);oldValue=value;firstTime=false;});});});// packages/alpinejs/src/directives/x-for.js
directive("for",function(el,_ref52,_ref53){var expression=_ref52.expression;var effect3=_ref53.effect,cleanup=_ref53.cleanup;var iteratorNames=parseForExpression(expression);var evaluateItems=evaluateLater(el,iteratorNames.items);var evaluateKey=evaluateLater(el,el._x_keyExpression||"index");el._x_prevKeys=[];el._x_lookup={};effect3(function(){return loop(el,iteratorNames,evaluateItems,evaluateKey);});cleanup(function(){Object.values(el._x_lookup).forEach(function(el2){return el2.remove();});delete el._x_prevKeys;delete el._x_lookup;});});function loop(el,iteratorNames,evaluateItems,evaluateKey){var isObject=function isObject(i){return _typeof(i)==="object"&&!Array.isArray(i);};var templateEl=el;evaluateItems(function(items){if(isNumeric3(items)&&items>=0){items=Array.from(Array(items).keys(),function(i){return i+1;});}var lookup=el._x_lookup;var prevKeys=el._x_prevKeys;var scopes=[];var keys=[];if(isObject(items)){items=Object.entries(items).map(function(_ref54){var _ref55=_slicedToArray(_ref54,2),key=_ref55[0],value=_ref55[1];var scope=getIterationScopeVariables(iteratorNames,value,key,items);evaluateKey(function(value2){return keys.push(value2);},{scope:_objectSpread({index:key},scope)});scopes.push(scope);});}else{for(var i=0;i<items.length;i++){var scope=getIterationScopeVariables(iteratorNames,items[i],i,items);evaluateKey(function(value){return keys.push(value);},{scope:_objectSpread({index:i},scope)});scopes.push(scope);}}var adds=[];var moves=[];var removes=[];var sames=[];for(var _i4=0;_i4<prevKeys.length;_i4++){var key=prevKeys[_i4];if(keys.indexOf(key)===-1)removes.push(key);}prevKeys=prevKeys.filter(function(key){return!removes.includes(key);});var lastKey="template";for(var _i5=0;_i5<keys.length;_i5++){var _key6=keys[_i5];var prevIndex=prevKeys.indexOf(_key6);if(prevIndex===-1){prevKeys.splice(_i5,0,_key6);adds.push([lastKey,_i5]);}else if(prevIndex!==_i5){var keyInSpot=prevKeys.splice(_i5,1)[0];var keyForSpot=prevKeys.splice(prevIndex-1,1)[0];prevKeys.splice(_i5,0,keyForSpot);prevKeys.splice(prevIndex,0,keyInSpot);moves.push([keyInSpot,keyForSpot]);}else{sames.push(_key6);}lastKey=_key6;}for(var _i6=0;_i6<removes.length;_i6++){var _key7=removes[_i6];lookup[_key7].remove();lookup[_key7]=null;delete lookup[_key7];}var _loop4=function _loop4(_i7){var _moves$_i=_slicedToArray(moves[_i7],2),keyInSpot=_moves$_i[0],keyForSpot=_moves$_i[1];var elInSpot=lookup[keyInSpot];var elForSpot=lookup[keyForSpot];var marker=document.createElement("div");mutateDom(function(){elForSpot.after(marker);elInSpot.after(elForSpot);marker.before(elInSpot);marker.remove();});refreshScope(elForSpot,scopes[keys.indexOf(keyForSpot)]);};for(var _i7=0;_i7<moves.length;_i7++){_loop4(_i7);}var _loop5=function _loop5(_i8){var _adds$_i=_slicedToArray(adds[_i8],2),lastKey2=_adds$_i[0],index=_adds$_i[1];var lastEl=lastKey2==="template"?templateEl:lookup[lastKey2];var scope=scopes[index];var key=keys[index];var clone2=document.importNode(templateEl.content,true).firstElementChild;addScopeToNode(clone2,reactive(scope),templateEl);mutateDom(function(){lastEl.after(clone2);initTree(clone2);});if(_typeof(key)==="object"){warn("x-for key cannot be an object, it must be a string or an integer",templateEl);}lookup[key]=clone2;};for(var _i8=0;_i8<adds.length;_i8++){_loop5(_i8);}for(var _i9=0;_i9<sames.length;_i9++){refreshScope(lookup[sames[_i9]],scopes[keys.indexOf(sames[_i9])]);}templateEl._x_prevKeys=keys;});}function parseForExpression(expression){var forIteratorRE=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/;var stripParensRE=/^\s*\(|\)\s*$/g;var forAliasRE=/([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/;var inMatch=expression.match(forAliasRE);if(!inMatch)return;var res={};res.items=inMatch[2].trim();var item=inMatch[1].replace(stripParensRE,"").trim();var iteratorMatch=item.match(forIteratorRE);if(iteratorMatch){res.item=item.replace(forIteratorRE,"").trim();res.index=iteratorMatch[1].trim();if(iteratorMatch[2]){res.collection=iteratorMatch[2].trim();}}else{res.item=item;}return res;}function getIterationScopeVariables(iteratorNames,item,index,items){var scopeVariables={};if(/^\[.*\]$/.test(iteratorNames.item)&&Array.isArray(item)){var names=iteratorNames.item.replace("[","").replace("]","").split(",").map(function(i){return i.trim();});names.forEach(function(name,i){scopeVariables[name]=item[i];});}else{scopeVariables[iteratorNames.item]=item;}if(iteratorNames.index)scopeVariables[iteratorNames.index]=index;if(iteratorNames.collection)scopeVariables[iteratorNames.collection]=items;return scopeVariables;}function isNumeric3(subject){return!Array.isArray(subject)&&!isNaN(subject);}// packages/alpinejs/src/directives/x-ref.js
function handler2(){}handler2.inline=function(el,_ref56,_ref57){var expression=_ref56.expression;var cleanup=_ref57.cleanup;var root=closestRoot(el);if(!root._x_refs)root._x_refs={};root._x_refs[expression]=el;cleanup(function(){return delete root._x_refs[expression];});};directive("ref",handler2);// packages/alpinejs/src/directives/x-if.js
directive("if",function(el,_ref58,_ref59){var expression=_ref58.expression;var effect3=_ref59.effect,cleanup=_ref59.cleanup;var evaluate2=evaluateLater(el,expression);var show=function show(){if(el._x_currentIfEl)return el._x_currentIfEl;var clone2=el.content.cloneNode(true).firstElementChild;addScopeToNode(clone2,{},el);mutateDom(function(){el.after(clone2);initTree(clone2);});el._x_currentIfEl=clone2;el._x_undoIf=function(){clone2.remove();delete el._x_currentIfEl;};return clone2;};var hide=function hide(){if(!el._x_undoIf)return;el._x_undoIf();delete el._x_undoIf;};effect3(function(){return evaluate2(function(value){value?show():hide();});});cleanup(function(){return el._x_undoIf&&el._x_undoIf();});});// packages/alpinejs/src/directives/x-on.js
mapAttributes(startingWith("@",into(prefix("on:"))));directive("on",skipDuringClone(function(el,_ref60,_ref61){var value=_ref60.value,modifiers=_ref60.modifiers,expression=_ref60.expression;var cleanup=_ref61.cleanup;var evaluate2=expression?evaluateLater(el,expression):function(){};var removeListener=on(el,value,modifiers,function(e){evaluate2(function(){},{scope:{$event:e},params:[e]});});cleanup(function(){return removeListener();});}));// packages/alpinejs/src/index.js
...
var module_default=src_default;/***/},/***/"./node_modules/axios/index.js":function node_modulesAxiosIndexJs(module,__unused_webpack_exports,__nested_webpack_require_97459__){module.exports=__nested_webpack_require_97459__(/*! ./lib/axios */"./node_modules/axios/lib/axios.js");/***/},/***/"./node_modules/axios/lib/adapters/xhr.js":function node_modulesAxiosLibAdaptersXhrJs(module,__unused_webpack_exports,__nested_webpack_require_97700__){"use strict";var utils=__nested_webpack_require_97700__(/*! ./../utils */"./node_modules/axios/lib/utils.js");var settle=__nested_webpack_require_97700__(/*! ./../core/settle */"./node_modules/axios/lib/core/settle.js");var cookies=__nested_webpack_require_97700__(/*! ./../helpers/cookies */"./node_modules/axios/lib/helpers/cookies.js");var buildURL=__nested_webpack_require_97700__(/*! ./../helpers/buildURL */"./node_modules/axios/lib/helpers/buildURL.js");var buildFullPath=__nested_webpack_require_97700__(/*! ../core/buildFullPath */"./node_modules/axios/lib/core/buildFullPath.js");var parseHeaders=__nested_webpack_require_97700__(/*! ./../helpers/parseHeaders */"./node_modules/axios/lib/helpers/parseHeaders.js");var isURLSameOrigin=__nested_webpack_require_97700__(/*! ./../helpers/isURLSameOrigin */"./node_modules/axios/lib/helpers/isURLSameOrigin.js");var createError=__nested_webpack_require_97700__(/*! ../core/createError */"./node_modules/axios/lib/core/createError.js");module.exports=function xhrAdapter(config){return new Promise(function dispatchXhrRequest(resolve,reject){var requestData=config.data;var requestHeaders=config.headers;if(utils.isFormData(requestData)){delete requestHeaders['Content-Type'];// Let the browser set it
...
request.send(requestData);});};/***/},/***/"./node_modules/axios/lib/axios.js":function node_modulesAxiosLibAxiosJs(module,__unused_webpack_exports,__nested_webpack_require_103050__){"use strict";var utils=__nested_webpack_require_103050__(/*! ./utils */"./node_modules/axios/lib/utils.js");var bind=__nested_webpack_require_103050__(/*! ./helpers/bind */"./node_modules/axios/lib/helpers/bind.js");var Axios=__nested_webpack_require_103050__(/*! ./core/Axios */"./node_modules/axios/lib/core/Axios.js");var mergeConfig=__nested_webpack_require_103050__(/*! ./core/mergeConfig */"./node_modules/axios/lib/core/mergeConfig.js");var defaults=__nested_webpack_require_103050__(/*! ./defaults */"./node_modules/axios/lib/defaults.js");/**
...
axios.Cancel=__nested_webpack_require_103050__(/*! ./cancel/Cancel */"./node_modules/axios/lib/cancel/Cancel.js");axios.CancelToken=__nested_webpack_require_103050__(/*! ./cancel/CancelToken */"./node_modules/axios/lib/cancel/CancelToken.js");axios.isCancel=__nested_webpack_require_103050__(/*! ./cancel/isCancel */"./node_modules/axios/lib/cancel/isCancel.js");// Expose all/spread
axios.all=function all(promises){return Promise.all(promises);};axios.spread=__nested_webpack_require_103050__(/*! ./helpers/spread */"./node_modules/axios/lib/helpers/spread.js");// Expose isAxiosError
axios.isAxiosError=__nested_webpack_require_103050__(/*! ./helpers/isAxiosError */"./node_modules/axios/lib/helpers/isAxiosError.js");module.exports=axios;// Allow use of default import syntax in TypeScript
 ...
 */CancelToken.source=function source(){var cancel;var token=new CancelToken(function executor(c){cancel=c;});return{token:token,cancel:cancel};};module.exports=CancelToken;/***/},/***/"./node_modules/axios/lib/cancel/isCancel.js":function node_modulesAxiosLibCancelIsCancelJs(module){"use strict";module.exports=function isCancel(value){return!!(value&&value.__CANCEL__);};/***/},/***/"./node_modules/axios/lib/core/Axios.js":function node_modulesAxiosLibCoreAxiosJs(module,__unused_webpack_exports,__nested_webpack_require_107155__){"use strict";var utils=__nested_webpack_require_107155__(/*! ./../utils */"./node_modules/axios/lib/utils.js");var buildURL=__nested_webpack_require_107155__(/*! ../helpers/buildURL */"./node_modules/axios/lib/helpers/buildURL.js");var InterceptorManager=__nested_webpack_require_107155__(/*! ./InterceptorManager */"./node_modules/axios/lib/core/InterceptorManager.js");var dispatchRequest=__nested_webpack_require_107155__(/*! ./dispatchRequest */"./node_modules/axios/lib/core/dispatchRequest.js");var mergeConfig=__nested_webpack_require_107155__(/*! ./mergeConfig */"./node_modules/axios/lib/core/mergeConfig.js");/**
 ...
 */module.exports=function createError(message,config,code,request,response){var error=new Error(message);return enhanceError(error,config,code,request,response);};/***/},/***/"./node_modules/axios/lib/core/dispatchRequest.js":function node_modulesAxiosLibCoreDispatchRequestJs(module,__unused_webpack_exports,__nested_webpack_require_113080__){"use strict";var utils=__nested_webpack_require_113080__(/*! ./../utils */"./node_modules/axios/lib/utils.js");var transformData=__nested_webpack_require_113080__(/*! ./transformData */"./node_modules/axios/lib/core/transformData.js");var isCancel=__nested_webpack_require_113080__(/*! ../cancel/isCancel */"./node_modules/axios/lib/cancel/isCancel.js");var defaults=__nested_webpack_require_113080__(/*! ../defaults */"./node_modules/axios/lib/defaults.js");/**
 * Throws a `Cancel` if cancellation has been requested.
...
config:this.config,code:this.code};};return error;};/***/},/***/"./node_modules/axios/lib/core/mergeConfig.js":function node_modulesAxiosLibCoreMergeConfigJs(module,__unused_webpack_exports,__nested_webpack_require_116079__){"use strict";var utils=__nested_webpack_require_116079__(/*! ../utils */"./node_modules/axios/lib/utils.js");/**
 ...
 */module.exports=function isAxiosError(payload){return _typeof(payload)==='object'&&payload.isAxiosError===true;};/***/},/***/"./node_modules/axios/lib/helpers/isURLSameOrigin.js":function node_modulesAxiosLibHelpersIsURLSameOriginJs(module,__unused_webpack_exports,__nested_webpack_require_127580__){"use strict";var utils=__nested_webpack_require_127580__(/*! ./../utils */"./node_modules/axios/lib/utils.js");module.exports=utils.isStandardBrowserEnv()?// Standard browser envs have full support of the APIs needed to test
 ...
 * @returns {Function}
 */module.exports=function spread(callback){return function wrap(arr){return callback.apply(null,arr);};};/***/},/***/"./node_modules/axios/lib/utils.js":function node_modulesAxiosLibUtilsJs(module,__unused_webpack_exports,__nested_webpack_require_132220__){"use strict";var bind=__nested_webpack_require_132220__(/*! ./helpers/bind */"./node_modules/axios/lib/helpers/bind.js");/*global toString:true*/ // utils is a library of generic helper functions non-specific to axios
 ...
 */function stripBOM(content){if(content.charCodeAt(0)===0xFEFF){content=content.slice(1);}return content;}module.exports={isArray:isArray,isArrayBuffer:isArrayBuffer,isBuffer:isBuffer,isFormData:isFormData,isArrayBufferView:isArrayBufferView,isString:isString,isNumber:isNumber,isObject:isObject,isPlainObject:isPlainObject,isUndefined:isUndefined,isDate:isDate,isFile:isFile,isBlob:isBlob,isFunction:isFunction,isStream:isStream,isURLSearchParams:isURLSearchParams,isStandardBrowserEnv:isStandardBrowserEnv,forEach:forEach,merge:merge,extend:extend,trim:trim,stripBOM:stripBOM};/***/},/***/"./resources/js/app.js":function resourcesJsAppJs(__unused_webpack_module,__webpack_exports__,__nested_webpack_require_140462__){"use strict";__nested_webpack_require_140462__.r(__webpack_exports__);/* harmony import */var alpinejs__WEBPACK_IMPORTED_MODULE_0__=__nested_webpack_require_140462__(/*! alpinejs */"./node_modules/alpinejs/dist/module.esm.js");__nested_webpack_require_140462__(/*! ./bootstrap */"./resources/js/bootstrap.js");window.Alpine=alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"];alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start();/***/},/***/"./resources/js/bootstrap.js":function resourcesJsBootstrapJs(__unused_webpack_module,__unused_webpack_exports,__nested_webpack_require_140994__){window._=__nested_webpack_require_140994__(/*! lodash */"./node_modules/lodash/lodash.js");/**
 * We'll load the axios HTTP library which allows us to easily issue requests
 * to our Laravel back-end. This library automatically handles sending the
 * CSRF token as a header based on the value of the "XSRF" token cookie.
 */window.axios=__nested_webpack_require_140994__(/*! axios */"./node_modules/axios/index.js");window.axios.defaults.headers.common['X-Requested-With']='XMLHttpRequest';/**
...
//     forceTLS: true
// });
/***/},/***/"./node_modules/lodash/lodash.js":function node_modulesLodashLodashJs(module,exports,__nested_webpack_require_142062__){/* module decorator */module=__nested_webpack_require_142062__.nmd(module);var __WEBPACK_AMD_DEFINE_RESULT__;/**
 * @license
...
!(__WEBPACK_AMD_DEFINE_RESULT__=function(){return _;}.call(exports,__nested_webpack_require_142062__,exports,module),__WEBPACK_AMD_DEFINE_RESULT__!==undefined&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__));}// Check for `exports` after `define` in case a build optimizer adds it.
else{}}).call(this);/***/},/***/"./resources/css/app.css":function resourcesCssAppCss(){throw new Error("Module build failed (from ./node_modules/mini-css-extract-plugin/dist/loader.js):\nModuleBuildError: Module build failed (from ./node_modules/css-loader/dist/cjs.js):\nError: Can't resolve '../webfonts/SairaCondensed-Bold.ttf' in 'D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\resources\\css'\n    at finishWithoutResolve (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\Resolver.js:293:18)\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\Resolver.js:362:15\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\Resolver.js:410:5\n    at eval (eval at create (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\tapable\\lib\\HookCodeFactory.js:33:10), <anonymous>:16:1)\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\Resolver.js:410:5\n    at eval (eval at create (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\tapable\\lib\\HookCodeFactory.js:33:10), <anonymous>:27:1)\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\DescriptionFilePlugin.js:87:43\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\Resolver.js:410:5\n    at eval (eval at create (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\tapable\\lib\\HookCodeFactory.js:33:10), <anonymous>:15:1)\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\enhanced-resolve\\lib\\Resolver.js:410:5\n    at processResult (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\webpack\\lib\\NormalModule.js:701:19)\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\webpack\\lib\\NormalModule.js:807:5\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\loader-runner\\lib\\LoaderRunner.js:399:11\n    at D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\loader-runner\\lib\\LoaderRunner.js:251:18\n    at context.callback (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\loader-runner\\lib\\LoaderRunner.js:124:13)\n    at Object.loader (D:\\DesarrolloSoftware\\PHP\\Magenta-Sky\\node_modules\\css-loader\\dist\\index.js:155:5)\n    at processTicksAndRejections (node:internal/process/task_queues:96:5)");/***/},/***/"./node_modules/process/browser.js":function node_modulesProcessBrowserJs(module){// shim for using process in browser
...
/******/function __nested_webpack_require_629803__(moduleId){/******/ // Check if module is in cache
...
/******/__webpack_modules__[moduleId].call(module.exports,module,module.exports,__nested_webpack_require_629803__);/******/ /******/ // Flag the module as loaded
...
/******/__nested_webpack_require_629803__.d=function(exports,definition){/******/for(var key in definition){/******/if(__nested_webpack_require_629803__.o(definition,key)&&!__nested_webpack_require_629803__.o(exports,key)){/******/Object.defineProperty(exports,key,{enumerable:true,get:definition[key]});/******/}/******/}/******/};/******/})();/******/ /******/ /* webpack/runtime/global */ /******/(function(){/******/__nested_webpack_require_629803__.g=function(){/******/if((typeof globalThis==="undefined"?"undefined":_typeof(globalThis))==='object')return globalThis;/******/try{/******/return this||new Function('return this')();/******/}catch(e){/******/if((typeof window==="undefined"?"undefined":_typeof(window))==='object')return window;/******/}/******/}();/******/})();/******/ /******/ /* webpack/runtime/hasOwnProperty shorthand */ /******/(function(){/******/__nested_webpack_require_629803__.o=function(obj,prop){return Object.prototype.hasOwnProperty.call(obj,prop);};/******/})();/******/ /******/ /* webpack/runtime/make namespace object */ /******/(function(){/******/ // define __esModule on exports
/******/__nested_webpack_require_629803__.r=function(exports){/******/if(typeof Symbol!=='undefined'&&Symbol.toStringTag){/******/Object.defineProperty(exports,Symbol.toStringTag,{value:'Module'});/******/}/******/Object.defineProperty(exports,'__esModule',{value:true});/******/};/******/})();/******/ /******/ /* webpack/runtime/node module decorator */ /******/(function(){/******/__nested_webpack_require_629803__.nmd=function(module){/******/module.paths=[];/******/if(!module.children)module.children=[];/******/return module;/******/};/******/})();/******/ /************************************************************************/ /******/ /******/ // startup
/******/ // Load entry module and return exports
/******/__nested_webpack_require_629803__("./resources/js/app.js");/******/ // This entry module doesn't tell about it's top-level declarations so it can't be inlined
/******/var __webpack_exports__=__nested_webpack_require_629803__("./resources/css/app.css");/******/ /******/})();
